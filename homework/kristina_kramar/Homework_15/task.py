...
#cursor.execute("SELECT * FROM marks where student_id='22513'")
#print(cursor.fetchall())

cursor.execute("SELECT * FROM books where taken_by_student_id='22513'")
print(cursor.fetchall())
...
# where students.id='22513' group by students.id, marks.id;
# '''
# )
#print(cursor.fetchall())
